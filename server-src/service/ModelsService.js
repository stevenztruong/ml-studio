...
exports.createModel = function(userId, body) {
  return new Promise(function(resolve, reject) {
    ...
    dbConnection.query(`INSERT INTO Model (userId, modelName, modelType) VALUES (${userId}, "${body.modelName}", "${body.modelType}")`, function (error, results, fields) {
      ...
      console.log(results);
      console.log(fields);
      const childPython = spawn('python3', [__dirname + '/../ml_invocation/ml.py', "createmodel", body.modelType, body.trainingData, body.classificationData, body.modelName], { env: { ...process.env, userId: userId }});
...
exports.trainModel = function(userId, body) {
  return new Promise(function(resolve, reject) {
    console.log(body);
    const childPython = spawn('python3', [__dirname + '/../ml_invocation/ml.py', "trainmodel", body.modelType, body.trainingData, body.classificationData, `${body.modelName}.pickle`], { env: { ...process.env, userId: userId }});
    childPython.stdout.on('data', (data) => {
        console.log(`stdout: ${data}`);
    })
